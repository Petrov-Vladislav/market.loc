...
@section('title', 'Добавить товар (Смартфон)')
...
<div class="content-header">
    <div class="container-fluid">
      <div class="row mb-2">
        <div class="col-sm-6">
          <h1 class="m-0">Добавить товар (Смартфон)</h1>
        </div>
                    ...
                    <form action="{{route('smartphone.store')}}" method="POST">
                      ...
                      <div class="card-body">
                        <div class="form-group">
                          ...
                          <input type="text" name="name" class="form-control" id="exampleInputName" placeholder="Введите название товара" required>
                        </div>
                        <div class="form-group">
                            <!-- select -->
                            <div class="form-group">
                              <label for="description">Описание</label>
                              <textarea name="text" class="editor" id="description"></textarea>
                            </div>
                            <div class="form-group">
